...
<head>
    ...
    <style>
        ...
        .modal-content { background: white; padding: 30px; border-radius: 15px; width: 500px; box-shadow: 0 5px 30px rgba(0,0,0,0.3); position: relative; animation: fadeIn 0.3s ease; }
        ...
        .btn-add-new { background: var(--primary-color); color: white; padding: 12px 25px; border: none; border-radius: 8px; cursor: pointer; font-weight: 600; transition: 0.3s; }
        ...
        .alert-success { background: #e8f5e9; border: 1px solid #2e7d32; color: #2e7d32; }
        .alert-error { background: #ffebee; border: 1px solid #c62828; color: #c62828; }
    </style>
</head>
<body>
    <div class="app">
